...
inline Vec3f max(Vec3f v1, Vec3f v2) {
	return Vec3f(fmax(v1.x,v2.x),fmax(v1.y,v2.y),fmax(v1.z,v2.z));
};

inline Vec3f min(Vec3f v1, Vec3f v2) {
	return Vec3f(fmin(v1.x,v2.x),fmin(v1.y,v2.y),fmin(v1.z,v2.z));
};
